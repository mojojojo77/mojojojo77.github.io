...
// Local Weather Function
	function localWeatherFunction(){
		...
		$.getJSON("https://freegeoip.net/json/",status,function(data){
			lat = data.latitude;
			lon = data.longitude;
			});
		urlOWM = "https://api.openweathermap.org/data/2.5/weather?lat="+lat+"&lon="+lon+"&APPID=f0deccd8666bd85749986f9353b61001";
...
// Global Weather Function
	function globalWeatherFunction(){
		...
		weatherIconClass = tempWeatherIconClass;
		userCity = $("#city").val();
		urlOWM = "https://api.openweathermap.org/data/2.5/weather?q="+userCity+"&APPID=f0deccd8666bd85749986f9353b61001";
		$.getJSON(urlOWM,status,function(data){
